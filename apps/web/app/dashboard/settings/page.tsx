            ...
            <div className="max-w-4xl mx-auto p-6 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6 md:col-span-2">
                        ...
                        <p className="text-sm text-gray-500">
                            Connect your social accounts to keep links handy for manual publishing.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {platforms.map((platform) => {
                                ...
                                return (
                                    <div
                                        key={platform.id}
                                        className={`p-4 rounded-xl border-2 transition-all ${connected
                                    ...
                                    >
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                ...
                                                {connected && conn && (
                                                    <p className="text-xs text-green-600 font-medium">{conn.account_name}</p>
                                                )}
                                            </div>
                                        </div>
                                        {connected ? (
                                            <button
                                                ...
                                                disabled={isLoading}
                                                className="w-full flex items-center justify-center gap-2 py-2 px-4 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-600 hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-all disabled:opacity-50"
                                            >
                                                {isLoading ? (
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6 md:col-span-2">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 text-green-600">
                                <h2 className="text-xl font-bold text-gray-800">Wallet & Earnings</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-2">
                                    <div className="flex-1 bg-gray-50 border-2 border-dashed border-gray-200 rounded-xl p-3 text-center font-mono font-bold text-xl tracking-widest text-gray-700 select-all">
                                    ...
                                    <button
                                        ...
                                        className="px-4 bg-gray-100 hover:bg-gray-200 rounded-xl font-bold text-gray-600 transition"
                                    >
                                        Copy
                                    </button>
                                </div>
                                <p className="text-xs text-gray-500">
                                    Earn <span className="font-bold text-green-600">$10.00</span> for every user who signs up with your code.
                                </p>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 bg-white border border-gray-200 rounded-xl p-3 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 uppercase"
                                    />
                                    <button
                                        onClick={handleClaimReferral}
                                        disabled={isClaiming || !referralInput}
                                        className="px-4 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition disabled:opacity-50 text-sm"
                                    >
                                        {isClaiming ? "..." : "Claim"}
                                    </button>
                                </div>
                                <p className="text-xs text-gray-500">
                                    Link your account to a referrer to support the community.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-4">
                            <label className="block">
                                <span className="text-sm font-semibold text-gray-700 flex justify-between">
                                    Risk Tolerance
                                    <span className="text-blue-600">{(riskTolerance * 100).toFixed(0)}%</span>
                                </span>
                                <input
                                    type="range"
                                    min="0"
                                ...
                                />
                                <div className="flex justify-between text-[10px] text-gray-400 mt-2 uppercase font-bold tracking-tighter">
                                    <span>Conservative</span>
                                    <span>Aggressive</span>
                                </div>
                            </label>
                            <p className="text-xs text-gray-500 italic">
                                Controls how aggressively ContentSwarm proposes high-risk/high-reward ideas.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="font-semibold text-gray-700">Grandma Mode</p>
                                    <p className="text-xs text-gray-500">High contrast, larger text by default.</p>
                                </div>
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input
                                        ...
                                        onChange={(e) => setIsGrandmaMode(e.target.checked)}
                                    />
                ...
                <div className="flex justify-end gap-4">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={isSaving}
                        className="flex items-center gap-2 px-8 py-2 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition shadow-lg shadow-blue-200 disabled:opacity-50"
                    >
